    ...
    internal static class KACResources
    {
        ...
        internal static void loadGUIAssets()
        {
            ...
            try
            {
                ...
                KACUtils.LoadImageFromFile(ref btnWarpNext, "img_buttonWarpNext.png");
        ...
        internal static GUIStyle styleButtonListAlarmActions34;
        ...
        internal static GUIStyle stylePct;
        ...
        internal static GUIStyle styleWarpTooltip;
        ...
        internal static void SetStyles()
        {
            ...
            styleHeadingNoWrap = new GUIStyle(styleHeading);
            styleHeadingNoWrap.wordWrap = false;
            ...
            styleContentNoWrap = new GUIStyle(styleContent);
            styleContentNoWrap.wordWrap = false;
            styleContentNoWrap.stretchWidth = false;
            ...
            styleButtonListAlarmActions34 = new GUIStyle(styleButtonListAlarmActions);
            styleButtonListAlarmActions34.fixedWidth = 34;
            ...
            styleHeader22Button = new GUIStyle(styleQAButton);
            styleHeader22Button.fixedWidth = 22;
            styleHeader22Button.border = new RectOffset(2, 2, 2, 2);
            ...
            stylePct = new GUIStyle(styleAddHeading);
            ...
            styleAddFieldWrap = new GUIStyle(styleAddField);
            styleAddFieldWrap.wordWrap = true;
